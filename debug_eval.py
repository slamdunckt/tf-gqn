...
model_dir = '/home/cylee/gqn/models/tf-gqn/maze_11/'
result_dir = './results/maze_debug/'
train = 0
...
output, output_gt, ctx = sess.run([net, example[1], example[0].context.frames])
...
for i in range(len(output)):
    ...
    for j, c in enumerate(ctx[i]):
        plt.imsave('{}/{}_ctx_{}.png'.format(outdir, i, j), c)
